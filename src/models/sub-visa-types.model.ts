...
export class SubVisaTypesModel extends Model<
  InferAttributes<SubVisaTypesModel>,
  InferCreationAttributes<SubVisaTypesModel>
> {
  ...
  declare visa_id: ForeignKey<VisaTypesModel["id"]>;
  declare visa_name: string;
  declare sub_visa_name: string;
...
export default SubVisaTypesModel;
